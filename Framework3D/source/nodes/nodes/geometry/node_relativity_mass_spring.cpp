...
static void node_mass_spring_declare(NodeDeclarationBuilder& b)
{
    ...
    b.add_input<decl::RelativityMassSpringSocket>("Mass Spring");
    ...
    b.add_input<decl::Float>("Speed of Light").default_val(1000).min(0).max(1000000);

    // Output 
    b.add_output<decl::RelativityMassSpringSocket>("Mass Spring Class");
...
static void node_register()
{
    ...
    strcpy(ntype.ui_name, "Relativity Mass Spring");
    strcpy_s(ntype.id_name, "geom_relativity_mass_spring");
