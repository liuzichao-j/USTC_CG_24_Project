...
#define RENDER_SOCKET_TYPES Lights, Camera, Texture, Meshes, Materials, Usd
...
#define GEO_SOCKET_TYPES Geometry, MassSpringSocket, RelativityMassSpringSocket, SPHFluidSocket, AnimatorSocket, BUFFER_TYPES
